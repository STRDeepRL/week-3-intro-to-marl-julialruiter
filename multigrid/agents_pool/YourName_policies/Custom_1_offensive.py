...
class Custom_1_offensive_Policy(Policy):
    """
    ...
    def __init__(self, policy_id: str, policy_name: str):
        ...
        self.reward_schemes = {
            self.policy_id: {
                ...
                "key_pickup_sparse_reward": 0.2,
                "ball_pickup_dense_reward": 0.2,
                "dense_reward_discount_factor": {"ball_carrying_discount_factor": 0.9},
                "invalid_pickup_dense_penalty": 0.01,
            }
        }
...
class Custom_1_full_offensive_Policy(Policy):
    """
    Policy class for STR MARL competition
    About Populations:
        We will make multiple instances of this class for every focal agent
    ...
    def __init__(self, policy_id: str, policy_name: str):
        ...
        self.reward_schemes = {
            self.policy_id: {
                "eliminated_opponent_sparse_reward": 0.7,
                "key_pickup_sparse_reward": 0.0,
                "ball_pickup_dense_reward": 0.0,
                "dense_reward_discount_factor": {"ball_carrying_discount_factor": 0.9},
